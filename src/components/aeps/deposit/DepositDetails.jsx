    ...
    return (
        <div className=''>
            ...
            <div className="card  card-stretch mb-5 mb-xxl-8">
                {/*begin::Header*/}
                <div className="card-header align-items-center border-1">
                    <h3 className="card-title align-items-start flex-column">
                        <span className="text-muted fw-semibold fs-6 text-uppercase">Payment Details
                        </span>
                    </h3>
                    ...
                    <div className="timeline-label">
                        ...
                        <div className="timeline-item">
                            ...
                            <div className="timeline-content fw-bold text-gray-800 ps-3">
                                Make deposit
                                <a href="#" className="text-primary">USD 700</a>. to
                                ESL
                            </div>
                            {/*end::Desc*/}
                        </div>
